...
fn task_edits_and_projection_recovery_preserve_new_state_and_originals() {
    ...
    assert!(project.join(format!(".state/projections/schema-10-revision-{head}/TASKS.md")).is_file());
}
#[test]
