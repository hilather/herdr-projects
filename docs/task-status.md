...
**25 cards have not started; T03.2, T03.3 and T03.4 are partial. Thirteen cards have local implementations and
...
| W03 | Transactional store, migration, outbox and reconciliation | 1 | 3 | 0 |
...
evidence, automatic repair and integrated recovery remain. Read-only recovery plans
now classify resources, retained workers and durable operations. Audited relinquishment
